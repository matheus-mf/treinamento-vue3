<template>
  <article class="flex justify-between w-full my-5">
    <button
    ...
    >
      <div class="w-12">
        <img class="w-full" src="../../assets/images/lamp.png" alt="Ideia">
      </div>
    ...
    >
      <div class="w-12">
        <img class="w-full" src="../../assets/images/fire.png" alt="Outro">
      </div>
